...
@interface CDVSTModalWindow : NSObject
...
@implementation CDVSTModalWindow{
...
+ (instancetype)sharedModalWindow{
    ...
    static CDVSTModalWindow *_sharedModalWindow = nil;
...
@interface CDVSTModal ()
@property (strong, nonatomic) UIView *containerView;
@end

@implementation CDVSTModal{
    CDVSTModalWindow *_window;
...
- (instancetype)init{
    if (self = [super init]){
        ...
        _window = [CDVSTModalWindow sharedModalWindow];
    }
    return self;
}
